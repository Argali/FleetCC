...
router.get("/entries", requireAuth, requirePerm("fuel", "view"), (req, res) => {
  res.json({ ok: true, data: entries });
});

router.get("/summary", requireAuth, requirePerm("fuel", "view"), (req, res) => {
  res.json({ ok: true, data: summary });
});

module.exports = router;
module.exports.getData = () => ({ entries, summary });
